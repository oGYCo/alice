...
from alice.api.v1.sources import _get_source_service
...
def _app_with_mock_service(mock_svc: AsyncMock):
    """Create a test app with SourceService overridden via dependency_overrides."""
    app = create_app()
    app.dependency_overrides[_get_source_service] = lambda: mock_svc
    return app
...
class TestUpdateSource:
    ...
    def test_update_source_calls_service(self):
        """PUT /sources/{id} passes correct source_id to svc.update_source."""
